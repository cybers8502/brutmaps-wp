...
function add_files()
{
    ...
    wp_enqueue_script('custom_module_script', get_template_directory_uri() . '/assets/index-RNYgArVJ.js', array(), null, true);
    wp_enqueue_style('custom_style', get_template_directory_uri() . '/assets/index-B-wOHw0Z.css', array(), null);
