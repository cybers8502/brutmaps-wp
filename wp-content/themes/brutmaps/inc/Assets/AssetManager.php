...
class AssetManager {
    ...
    public function enqueue() {
        ...
        wp_enqueue_script('custom_module_script', get_template_directory_uri() . '/assets/index-Dfu9J99J.js', [], null, true);
        wp_enqueue_style('custom_style', get_template_directory_uri() . '/assets/index-Cs-b95r8.css', [], null);
