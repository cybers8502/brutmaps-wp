...
class AssetManager
{
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_script('custom_module_script', get_template_directory_uri() . '/publish/assets/index-DWvcUMp2.js', [], null, true);
        wp_enqueue_style('custom_style', get_template_directory_uri() . '/publish/assets/index-wPMS5mj4.css', [], null);
