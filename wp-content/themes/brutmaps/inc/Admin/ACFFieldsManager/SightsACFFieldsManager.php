...
//            (new ACFFieldConfig())->wysiwyg('field_object_main_content', 'Main Content', 'main_content'),
            (new ACFFieldConfig())->postObject('field_object_choose_architects', 'Choose architects', 'choose_architects', 'architect', true, '40'),
...
//            (new ACFFieldConfig())->image('field_object_main_image', 'Main Image', 'main_image', true),
