...
class UserProfileController
{
    ...
    {
        register_rest_route(BASE_URL, '/user-profile', [
            'methods' => 'GET',
            'callback' => [$this, 'getProfile'],
            'permission_callback' => fn() => is_user_logged_in(),
        ]);

        register_rest_route(BASE_URL, '/edit-profile', [
            'methods' => 'POST',
            'callback' => [$this, 'editProfile'],
            'permission_callback' => fn() => is_user_logged_in(),
        ]);

        register_rest_route(BASE_URL, '/user-countries', [
            'methods' => 'GET',
            'callback' => [$this, 'getUserCountries'],
            'permission_callback' => '__return_true',
        ]);

        register_rest_route(BASE_URL, '/delete-account', [
            'methods' => 'DELETE',
